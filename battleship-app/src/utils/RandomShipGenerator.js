...
function generateShipLocations() {
    ...
    for (let size of shipsSize) {
        ...
        while (shipLocationsOccupied) { // true
            shipLocations = randomLocation(size);
            shipLocationsOccupied = checkOccupied(shipLocationSet, [...shipLocations]);
        }
...
function randomLocation(shipSize) {
    ...
    console.log("direction: " + direction + " index1: " + index1 + " index2: " + index2);
